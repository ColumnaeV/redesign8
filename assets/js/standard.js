...
document.onreadystatechange = function () {
    ...
    if (state == 'interactive') {
        ...
        if (0 <= currentTime&&currentTime < 7) {
            $('div.loading-img-cont').append("<img id='loading-image' alt='Loading Image' src='assets/img/logo-light.png'>");
            $('div.footer-img-cont').append("<img class='footer-img' alt='Footer Image' src='assets/img/logo-light.png'>");
            $('span.vsco-cont').append("<img class='soc-med-icon' alt='VSCO Link' src='assets/img/socmed/vsco.svg'>");
            $('span.cnc-logo').append("<img class='ps-img' alt='C&C Studios Logo' src='assets/img/cnc-light.png'>");
        }
        if (7 <= currentTime&&currentTime < 19) {
            $('div.loading-img-cont').append("<img id='loading-image' alt='Loading Image' src='assets/img/logo-dark.png'>");
            $('div.footer-img-cont').append("<img class='footer-img' alt='Footer Image' src='assets/img/logo-dark.png'>");
            $('span.vsco-cont').append("<img class='soc-med-icon' alt='VSCO Link' src='assets/img/socmed/vsco-light.svg'>");
            $('span.cnc-logo').append("<img class='ps-img' alt='C&C Studios Logo' src='assets/img/cnc-dark.png'>");
        }
